...
const InsertCustomerSmallTruck = () => {
    ...
    return (
        <React.Fragment>
            <Button variant="contained" color="info" startIcon={<BookOnlineIcon sx={{ transform: "rotate(90deg)" }} />} onClick={handleClickOpen} fullWidth>เพิ่มลูกค้ารถเล็ก</Button>
            <Dialog
                open={open}
                keepMounted
                onClose={handleClose}
            ...
            >
                <DialogTitle sx={{ backgroundColor: theme.palette.panda.dark }}>
                    <Grid container spacing={2}>
                        <Grid item xs={10}>
                            <Typography variant="h6" fontWeight="bold" color="white" >เพิ่มลูกค้ารถเล็ก</Typography>
                        </Grid>
...
export default InsertCustomerSmallTruck;

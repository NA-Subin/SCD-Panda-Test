            ...
            <Box sx={{ overflowY: 'auto', flex: 1, marginLeft: shouldDrawerOpen ? 0 : -3, marginRight: shouldDrawerOpen ? 0 : -3 }}>
              ...
              {(
                ...
                <>
                  ...
                  >
                    <Collapse in={!report} unmountOnExit={false}>
                      {["สรุปยอดส่งน้ำมัน", "สรุปค่าเที่ยว", "การชำระค่าน้ำมัน", "การชำระค่าขนส่ง", "ค่าใช้จ่าย", "เงินเดือน", "ปิดงบบัญชีการเงิน"].map((text, index) => (
                        <ListItem
                          key={text}
                          disablePadding
                          sx={{
                        ...
                        >
                          <ListItemButton
                            component={Link}
                            to={
                              index === 0 ? "/summary-oil-balance" : index === 1 ? "/report-driver-trip" : index === 2 ? "/report-fuel-payment" : index === 3 ? "/report-transport-payment" : index === 4 ? "/expenses" : index === 5 ? "/salary" : "/close-financial"
                            }
